  ...
  lastTermsInfo: [
    {
      ...
      courseSyllabus: {
        ...
        content: {
          ...
          en:
            '<p>The project tasks may include</p><ul><li>processing laboratory data</li><li>design of a measurement technique</li><li>literature search and summary of a particular field</li><li>programming of data processing and presentation tools.</li></ul>'
        },
        eligibility: {
          sv:
            '<p>F&#246;r frist&#229;ende studenter: allm&#228;nna antagningsvillkor och engelska A eller motsvarande.</p>',
          en:
            '<p>For single course students: general admission requirements including documented proficiency in&#160;English A.</p>'
        },
        examComments: {
          sv:
