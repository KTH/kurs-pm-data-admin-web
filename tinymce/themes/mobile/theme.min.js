      ...
      M(u, function (n, o) {
        ...
        c.push(r),
          (t[r] = function () {
            ...
            if (e !== i.length)
              throw new Error(
                'Wrong number of arguments to case ' + r + '. Expected ' + i.length + ' (' + i + '), got ' + e
              )
            return {
              fold: function () {
                for (var n = [], e = 0; e < arguments.length; e++) n[e] = arguments[e]
      ...
      return (
        ...
        Z(
          10 < (e = n.errors).length
            ? e.slice(0, 10).concat([{ path: [], getErrorInfo: w('... (only showing first ten failures)') }])
            : e,
          function (n) {
    ...
    Zo = function (n) {
      return Z(n, function (n) {
        return (
          0,
          (e = n.length - '/*'.length),
          n.length >= '/*'.length && '/*' === n.substr(e, e + '/*'.length) ? n.substring(0, n.length - '/*'.length) : n
        )
        var e
      })
    },
  ...
  function Fs(u, c) {
    return function (n, e) {
      return (
        ...
        _s(
          n,
          Rs((i = (t = c) ? is(o).x : r(is(o).x, Na(o), ja(o), Ka(o))), t ? r(is(o).y, Ha(o), La(o), Ka(o)) : is(o).y)
        ),
        mn.some(i).map(x)
      )
      var t, o, r, i
          ...
          n.innerHtml.each(function (n) {
            return (
              ...
              xe(
                ...
                ((o = t), ((r = (i || document).createElement('div')).innerHTML = o), Je(fe.fromDom(r)))
              ),
              we(e),
              void Qe(e, u)
            )
  ...
  var Kl,
          ...
          items: [
            ...
            (l = Ns({
              ...
              components: B(s.fields, function (n, e) {
                return e <= s.maxFieldIndex
                  ? [ka('<div class="${prefix}-dot-item ${prefix}-icon-full-dot ${prefix}-icon"></div>')]
                  : []
              }),
            })),
            {
    ...
    Od = lo([
      ho(
        ...
        'dom',
        Ot(),
        lo([Lt('tag'), Yt('styles', {}), Yt('classes', []), Yt('attributes', {}), Ut('value'), Ut('innerHtml')])
      ),
      Lt('components'),
      Lt('uid'),
      Yt('events', {}),
      ...
      Dr('builder', function (n) {
        return {
          ...
          domModification: y(y({}, n.domModification), {
            attributes: y(
              y(y({ role: n.toggling.isSome() ? 'menuitemcheckbox' : 'menuitem' }, n.domModification.attributes), {
    ...
    Ng = function (t) {
      ...
      var i = ig(),
        ...
        e = function (n) {
          n.connect(u),
            qe(n.element) ||
              (i.register(n), M(n.components(), e), u.triggerEvent(oe(), n.element, { target: n.element }))
        },
        c = function (n) {
        ...
        function O(n, e, t, o) {
          ...
          var r,
            ...
            c =
              ((r = e),
              (i = t),
              { readOnly: (u = n.get()).backToMask.concat(r.get()), main: u.backToMask.concat(i.get()) })
