...
!(function() {
  ...
  function w(e, t) {
    ...
    const i = L()
    const s = c(
      (((n = {})[o.name] = o), (n[a.name] = a), (n[r.name] = r), (n[i.name] = i), n),
      t.get()
    )
    return (function(e) {
      ...
      function(e) {
        return (function(e, t) {
          const n = {}
          const o = y(e, function(e) {
            return typeof e === 'string' ? (E(t, e) && (n[e] = t[e]), e) : (n[e.name] = e).name
          })
  ...
  var x = {
    ...
    none: n,
    from(e) {
      return e === null || e === undefined ? m : T(e)
    }
  }
  const P =
    ((C = 'function'),
    function(e) {
      return (
        (function(e) {
          ...
          const t = typeof e
          return t == 'object' &&
            (Array.prototype.isPrototypeOf(e) || (e.constructor && e.constructor.name === 'Array'))
            ? 'array'
            : t == 'object' &&
  ...
  var F = (P(Array.from) && Array.from, Object.keys)
  ...
  const I = [
    ...
    { shortcuts: ['Access + 4'], action: 'Heading' },
    { shortcuts: ['Access + 5'], action: 'Header 5' },
    { shortcuts: ['Access + 6'], action: 'Header 6' },
    { shortcuts: ['Access + 7'], action: 'Body text' },
  ...
  const _ = tinymce.util.Tools.resolve('tinymce.Env')
  const j = function(e) {
    const n = _.mac
      ? {
          alt: '&#x2325;',
      ...
      items: [
        {
          ...
          cells: y(I, function(e) {
            const t = y(e.shortcuts, j).join(' or ')
            return [e.action, t]
          })
        }
      ]
  ...
  const U = tinymce.util.Tools.resolve('tinymce.util.I18n')
  const W = [
  ...
  var D = function(e) {
    function r(t, n) {
      return (function(e, t) {
        ...
        function() {
          const e = t.plugins[n].getMetadata
          return typeof e === 'function' ? o(e()) : n
        },
        function(e) {
    ...
    let t
    let n
    var o = l(k, '<a href="${url}" target="_blank" rel="noopener">${name}</a>')
    return {
      name: 'plugins',
      title: 'Plugins',
      items: [
  ...
  const N = tinymce.util.Tools.resolve('tinymce.EditorManager')
  var L = function() {
    let e
    let t
    const n =
      ...
      ((e = N.majorVersion), (t = N.minorVersion), e.indexOf('@') === 0 ? 'X.X.X' : e + '.' + t) +
      '</a>'
    return {
      name: 'versions',
      title: 'Version',
