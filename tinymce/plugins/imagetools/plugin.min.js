    ...
    j = function (h) {
      return new I(function (e, t) {
        !(function () {
          ...
          if (!t) return p.none()
          for (
            var n = t[1], r = e[1], o = atob(r), i = o.length, a = Math.ceil(i / 1024), u = new Array(a), c = 0;
            c < a;
            ++c
          ) {
    ...
    T(a, function (e, r) {
      ...
      u.push(i),
        (n[i] = function () {
          ...
          if (t !== o.length)
            throw new Error(
              'Wrong number of arguments to case ' + i + '. Expected ' + o.length + ' (' + o + '), got ' + t
            )
          return {
            fold: function () {
  ...
  var V = function (e, t, n) {
    ...
    G = function (e, t, n) {
      var r = w(e.width, e.height),
        o = R(r)
      return (
        'v' === n ? (o.scale(1, -1), o.drawImage(e, 0, -r.height)) : (o.scale(-1, 1), o.drawImage(e, -r.width, 0)),
        k(r, t)
      )
    },
    J = [
  ...
  function ue(e, t) {
    if (_e(e, t))
      return q(
        t.src,
        null,
        ((n = t), -1 !== f.inArray(e.getParam('imagetools_credentials_hosts', [], 'string[]'), new ye(n.src).host))
      )
    var n, r
        ...
        re(s, t.dom).each(function (e) {
          ce(s, t.dom).then(function (e) {
            ...
            s.windowManager.open({
              ...
              body: {
                type: 'panel',
                items: [{ type: 'imagetools', name: 'imagetools', label: 'Edit Image', currentState: t }],
              },
              buttons: [
                            ...
                            (u.w === i.w && u.h === i.h) ||
                              (Y(a) &&
                                ...
                                (n = i) &&
                                  ...
                                  (o = t.height),
                                  (r || o) &&
                                    (t.setAttribute('width', String(n.w)), t.setAttribute('height', String(n.h)))))),
                            URL.revokeObjectURL(e.src),
                            c
                          )
                        })
