...
!(function(t) {
              ...
              (function f(e, t, n) {
                ...
                e: for (;;) {
                  if (
                    ...
                    3 === l.nodeType &&
                      (!o && l.length + u >= c.end ? ((o = l), (a = c.end - u)) : r && s.push(l),
                      !r && l.length + u > c.start && ((r = l), (i = c.start - u)),
                      (u += l.length)),
                    r && o)
                  ) {
                    if (
        ...
        return function(e, t, r, o) {
          ...
          ;(n['addToDictionary' === e ? 'word' : 'text'] = t),
            ...
            d.send({
              ...
              error: function() {
                var e =
                  a.translate('The spelling service was not found: (') + h(a) + a.translate(')')
                o(e)
              }
            })
        }
  ...
  var y = function(e, t, n) {
      ...
      if ((v(e, n).reset(), e.selection.moveToBookmark(r), n.set(null), t.get()))
