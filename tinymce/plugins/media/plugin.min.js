              ...
              ne(
                {
                  ...
                  start: function(e, t, r) {
                    ...
                    if (o)
                      switch (e) {
                        case 'video':
                          y(t, { poster: i.poster, src: '' }), i.source2 && y(t, { src: '' })
                          break
                        case 'iframe':
                          y(t, { src: i.source1 })
                          break
                        case 'source':
                          if (
                            ++u <= 2 &&
                            (y(t, { src: i['source' + u], type: i['source' + u + 'mime'] }),
                            !i['source' + u])
                          )
                            return
                          break
                    ...
                    if ('video' === e && o)
                      for (var t = 1; t <= 2; t++)
                        if (i['source' + t]) {
                          ...
                          ;(r.map = {}),
                            u < t &&
                              (y(r, { src: i['source' + t], type: i['source' + t + 'mime'] }),
                              c.start('source', r, !0))
                        }
                    if (i.poster && 'object' === e && o && !a) {
                      var n = []
                      ;(n.map = {}),
                        y(n, { src: i.poster, width: i.width, height: i.height }),
                        c.start('img', n, !0)
                    }
                    c.end(e)
                  }
      ...
      return r
        ? (function(n, i, o) {
            return new ce(function(t, e) {
              function r(e) {
                return (
                  e.html && (he[n.source1] = e), t({ url: n.source1, html: e.html ? e.html : i(n) })
                )
              }
    ...
    Se = function(d) {
      d.on('preInit', function() {
        ...
        re.each('webkitallowfullscreen mozallowfullscreen allowfullscreen'.split(' '), function(e) {
          ...
          d.parser.addNodeFilter('iframe,video,audio,object,embed,script', Ae(d)),
      ...
      t.on('click keyup touchend', function() {
        ...
        t.on('ObjectResized', function(e) {
          ...
          r.getAttribute('data-mce-object') &&
            ...
            r.setAttribute(
              'data-mce-html',
              escape(de(t, { width: String(e.width), height: String(e.height) }))
            ))
        })
    },
    Me = function(e) {
