...
!(function () {
            ...
            if (!m.get()) {
              if ('video' === e && s)
                for (var t, r = 0; r < 2; r++)
                  c[te[r]] &&
                    (((t = []).map = {}),
                    d <= r && (O(t, { src: c[te[r]], type: c[te[r] + 'mime'] }), l.start('source', t, !0)))
              var n
              c.poster &&
                'object' === e &&
                s &&
                !u &&
                (((n = []).map = {}), O(n, { src: c.poster, width: c.width, height: c.height }), l.start('img', n, !0))
            }
            l.end(e)
          },
        },
  ...
  function _(e, t) {
    for (
      var r,
        n = (r = t.match(/^(https?:\/\/|www\.)(.+)$/i)) && 1 < r.length && 'www.' !== r[1] ? r[1] : 'https://',
        a = e.regex.exec(t),
        o = n + e.url,
        i = 0;
      i < a.length;
  ...
  function N(m) {
    var e,
      ...
      r,
      n =
        ((r = A((t = (e = m).selection.getNode())) ? e.serializer.serialize(t, { selection: !0 }) : ''),
        p({ embed: r }, y(v(e), r))),
      d = f(n),
      a = P(n),
      o = {
    ...
    m.getParam('media_alt_source', !0) &&
      i.push({ name: 'altsource', type: 'urlinput', filetype: 'media', label: 'Alternative source URL' }),
        ...
        switch (t.name) {
          case 'source':
            ;(u = d.get()),
              ...
              u.source !== l.source && (F(h, m)({ url: l.source, html: '' }), C(m, l).then(F(h, m)).catch($(m)))
            break
          case 'embed':
              ...
              if ((r = e[l]).parent) {
                ...
                'script' === s && n.attr('type', 'text/javascript'),
                  (i = r.attr('data-mce-html')) &&
                    (((c = new oe('#text', 3)).raw = !0), (c.value = U(d, unescape(i))), n.append(c)),
                  r.replace(n)
              }
          })
      }),
      ...
      n.on('ObjectResized', function (e) {
        ...
        !r.getAttribute('data-mce-object') ||
          ((t = r.getAttribute('data-mce-html')) &&
            ((t = unescape(t)),
            r.setAttribute('data-mce-html', escape(S(t, { width: String(e.width), height: String(e.height) })))))
      }),
      (a = e),
      {
        showDialog: function () {
