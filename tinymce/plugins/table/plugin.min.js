...
!(function(f) {
  ...
  function F(e, n, t) {
    if (!(_e(t) || je(t) || He(t)))
      throw (f.console.error('Invalid call to Attr.set. Key ', n, ':: Value ', t, ':: Element ', e),
  ...
  var Pe = function(t) {
    ...
    on = {
      fromHtml: function(e, n) {
        ...
        if (((t.innerHTML = e), !t.hasChildNodes() || 1 < t.childNodes.length))
          throw (f.console.error('HTML does not have a single root node', e),
    ...
    Dn = [
      ...
      { name: 'OSX', search: de('os x'), versionRegexes: [/.*?os\ x\ ?([0-9]+)_([0-9]+).*/] },
  ...
  var Bt = (function Qf(t, r) {
    ...
    Lt = function(e, n) {
      for (var t = !0, r = b(kt, n), o = n.startRow(); o <= n.finishRow(); o++)
        for (var i = n.startCol(); i <= n.finishCol(); i++) t = t && mt.getAt(e, o, i).exists(r)
    ...
    return In(c, a)
      ...
      : er(c).bind(function(u) {
          return er(a).bind(function(i) {
            if (In(u, i)) return Me.some(sr.create({ boxes: Gt(u, c, a), start: c, finish: a }))
            if (Bn(u, i)) {
              var e = 0 < (n = ke(a, 'td,th', l(u))).length ? n[n.length - 1] : a
              return Me.some(sr.create({ boxes: Yt(u, c, u, a, i), start: c, finish: e }))
            }
            if (Bn(i, u)) {
              var n,
                t = 0 < (n = ke(c, 'td,th', l(i))).length ? n[n.length - 1] : c
              return Me.some(sr.create({ boxes: Yt(i, c, u, a, i), start: c, finish: t }))
            }
            return fr
              .ancestors(c, a)
              .shared()
              .bind(function(e) {
                return et(e, 'table', r).bind(function(e) {
                  ...
                  return Me.some(sr.create({ boxes: Yt(e, c, u, a, i), start: o, finish: t }))
                })
              })
          })
        })
    ...
    Tr = function(t, e) {
      return Rr.cata(
        ...
        function(n, e) {
          return 0 === n.length
            ? Me.none()
            : vr(t, Cr.firstSelectedSelector(), Cr.lastSelectedSelector()).bind(function(e) {
      ...
      registerEvents: function(c, e, a, l) {
        c.on('BeforeGetContent', function(n) {
          ...
          c.on('BeforeSetContent', function(u) {
            !0 === u.selection &&
              !0 === u.paste &&
              Me.from(c.dom.getParent(c.selection.getStart(), 'th,td')).each(function(e) {
                var i = on.fromDom(e)
    ...
    uo = {
      ...
      getGenericWidth: function(e) {
        return zr(e).bind(function(e) {
          var n = to.exec(e)
          return null !== n ? Me.some({ width: D(parseFloat(n[1])), unit: D(n[3]) }) : Me.none()
        })
      },
        ...
        .fold(
          ...
          function(e) {
            ...
            return (
              ...
              f(r),
              au(t, r, go.height, i),
              Me.some({ cursor: e.cursor, newRows: n.newRows, newCells: n.newCells })
            )
          }
        )
    }
  ...
  function Pi(n, e) {
    ...
    return {
      ...
      bordercolor: ie(on.fromDom(e), 'border-color')
        .map(t)
        .getOr(''),
      backgroundcolor: ie(on.fromDom(e), 'background-color')
        .map(t)
        .getOr('')
    }
  }
        ...
        !(function(e, n, t) {
          ...
          if (
            ...
            r.getAttrib(n, 'width') && !Di(e)
              ...
              : (i.width = yi(t.width)),
            Di(e)
              ? ((i['border-width'] = yi(t.border)), (i['border-spacing'] = yi(t.cellspacing)))
              : ((o.border = t.border),
            ...
            for (var u = 0; u < n.children.length; u++)
              na(r, n.children[u], { 'border-width': yi(t.border), padding: yi(t.cellpadding) }),
                Oi(e) && na(r, n.children[u], { 'border-color': t.bordercolor })
          Oi(e) &&
          ...
          !o &&
            u.caption &&
            (((o = i.create('caption')).innerHTML = Jc.ie ? '\xa0' : '<br data-mce-bogus="1"/>'),
  ...
  var Xi,
    ...
    vu = function(o, i) {
      ...
      return g(o, function(e, r) {
        var n = x(e.cells(), function(e, n) {
          ...
          return (
            (function(e, n, t, r) {
              for (var o = e; o < e + t; o++) for (var i = n; i < n + r; i++) u[o][i] = !0
    ...
    Tu = function(e, n, t, r) {
      ...
      for (var o = n.startRow(); o <= n.finishRow(); o++)
        for (var i = n.startCol(); i <= n.finishCol(); i++) pu.mutateCell(e[o], i, Un(r(), !1))
      return e
    },
    Ou = function(e, n, t, r) {
              ...
              ;(i = n),
                ...
                1 < i.length &&
                  ...
                  ((0 < c && a(pu.getCellElement(l, c - 1))) ||
                    (c < l.cells().length - 1 && a(pu.getCellElement(l, c + 1))) ||
    ...
    ku = function(e, t, r, o, i) {
      return g(e, function(e) {
        var n =
          0 < t && t < pu.cellLength(e) && o(pu.getCellElement(e, t - 1), pu.getCellElement(e, t))
            ? pu.getCell(e, t)
    ...
    Qu = function(n, t) {
      ...
      function o(e) {
        var n = r(e)
        return i.get().isNone() && i.set(Me.some(n)), (u = Me.some({ item: e, replacement: n })), n
      }
      var i = R(Me.none()),
        u = Me.none()
      return {
    ...
    Zu = function(c, a) {
      return function(r) {
        ...
        function i(e) {
          var n = { scope: c },
            t = r.replace(e, a, n)
          return u.push({ item: e, sub: t }), o.get().isNone() && o.set(Me.some(t)), t
        }
        var u = []
        return {
        ...
        function(n, t) {
          return lt.cell(t.element()).bind(function(e) {
            return Lo(n, e).map(function(e) {
              return fn(fn({}, e), { generators: t.generators, clipboard: t.clipboard })
            })
          })
        },
        dc,
    ...
    Hc = function(e, n) {
      var t,
        ...
        l = n
          ? ((t = a),
            (r = I(u, 'border-style').getOr('')),
            (o = I(u, 'border-color').getOr('')),
            (i = I(u, 'background-color').getOr('')),
    ...
    Uc = function(e) {
      return (function(n) {
        ...
        return 0 < e.length
          ? Me.some({ name: 'class', type: 'selectbox', label: 'Class', items: t })
          : Me.none()
      })(e).fold(
        function() {
          return Fc
    ...
    Vc = function(n) {
      ...
      if (
        ...
        var r = Dc.map(t, function(e) {
          ...
          i = {
            type: 'tabpanel',
            tabs: [{ title: 'General', name: 'general', items: Uc(n) }, _c('cell')]
          },
          u = { type: 'panel', items: [{ type: 'grid', columns: 2, items: Uc(n) }] }
    ...
    Kc = function(n) {
      ...
      if (
        ...
        var i = Dc.map(o, function(e) {
          ...
          c = {
            type: 'tabpanel',
            tabs: [{ title: 'General', name: 'general', items: Yc(n) }, _c('row')]
          },
          a = { type: 'panel', items: [{ type: 'grid', columns: 2, items: Yc(n) }] }
        n.windowManager.open({
    ...
    na = function(e, n, t, r) {
      if ('TD' === n.tagName || 'TH' === n.tagName) _e(t) ? e.setStyle(n, t, r) : e.setStyle(n, t)
      else if (n.children) for (var o = 0; o < n.children.length; o++) na(e, n.children[o], t, r)
    },
    ta = function(e, n) {
      var t,
        r = e.dom,
      ...
      !1 === n
        ? (t = r.getParent(e.selection.getStart(), 'table'))
          ? (o = Lc(e, t, Oi(e)))
          : Oi(e) && ((o.borderstyle = ''), (o.bordercolor = ''), (o.backgroundcolor = ''))
        : ((o.cols = '1'),
          (o.rows = '1'),
          Oi(e) && ((o.borderstyle = ''), (o.bordercolor = ''), (o.backgroundcolor = '')))
      var i = 0 < Ai(e).length
      ...
      var u = { type: 'grid', columns: 2, items: ea(e, i, n) },
        c = Oi(e)
          ? {
              type: 'tabpanel',
              tabs: [{ title: 'General', name: 'general', items: [u] }, _c('table')]
            }
          : { type: 'panel', items: [u] }
              ...
              o(n, e).each(function(e) {
                !(function(e, n, t) {
                  ...
                  ;(n.width === r.width && n.height === r.height) ||
                    (Ii(e, t.dom(), n.width, n.height), Bi(e, t.dom(), r.width, r.height))
                })(c, t, n),
    ...
    ca = function(e) {
      var n = Me.from(e.dom().documentElement)
        .map(on.fromDom)
        .getOr(e)
      ...
      sink: function(e, n) {
        var t = (function(e) {
            ...
            U(t, 'role', 'presentation'),
              re(t, { position: 'fixed', left: '0px', top: '0px', width: '100%', height: '100%' }),
  ...
  function Ya(e) {
    ...
    return za(n, e.anchorOffset, t, e.focusOffset)
      ? Me.some(Dl.create(n, e.anchorOffset, t, e.focusOffset))
      : (function(e) {
          if (0 < e.rangeCount) {
  ...
  function ll(e) {
    return mf.nu({ left: e.left, top: e.top, right: e.right, bottom: e.bottom })
  }
  function fl(e, n) {
  ...
  var hl = function(n, t, e) {
    ...
    Dl = { create: B('start', 'soffset', 'finish', 'foffset') },
    Al = Sr([{ before: ['element'] }, { on: ['element', 'offset'] }, { after: ['element'] }]),
    El = {
      before: Al.before,
      on: Al.on,
      after: Al.after,
      ...
      return tn(n)
        ...
        : (function(n, e, t, r) {
            ...
            return bo(i, function(e) {
              return (
                o.selectNode(e.dom()),
                Na(o.getBoundingClientRect(), t, r) ? Ml(n, e, t, r) : Me.none()
              )
            })
          })(e, n, t, r)
    },
    Wl = document.caretPositionFromPoint
      ? function(t, e, n) {
        ...
        if (n.keyCode === _l.TAB) {
          ...
          if (e.collapsed) {
            ...
            lt.cell(c, u).each(function(e) {
              n.preventDefault(),
                (n.shiftKey ? Za : Qa)(t, u, e, r, o).each(function(e) {
    ...
    Hl = { create: B('selection', 'kill') },
    Fl = function(e, n, t, r) {
      return { start: D(El.on(e, n)), finish: D(El.on(t, r)) }
    },
    Ul = {
        ...
        : dr(r, n, e).bind(function(e) {
            ...
            return 0 < n.length
              ? (o(t, n, e.start(), e.finish()),
                Me.some(Hl.create(Me.some(Ul.makeSitus(r, 0, r, wt(r))), !0)))
              : Me.none()
          })
    },
    Vl = {
      ...
      update: function(e, n, t, r, o) {
        return gr(r, e, n, o.firstSelectedSelector(), o.lastSelectedSelector()).map(function(e) {
          return (
            o.clearBeforeUpdate(t), o.selectRange(t, e.boxes(), e.start(), e.finish()), e.boxes()
          )
        })
      }
    },
    ...
    Xl = [
      { current: tl, next: Yl, fallback: Me.none() },
      { current: Yl, next: Kl, fallback: Me.some(tl) },
      { current: Kl, next: Kl, fallback: Me.some(Yl) }
    ],
    $l = function(n, t, r, o, e) {
      return (
        void 0 === e && (e = Xl),
        y(e, function(e) {
          return e.current === r
    ...
    Zl = function(n, e, t, r, o, i) {
      return $l(n, e, r, o).bind(function(e) {
        return i(e.item())
          ? Me.none()
          : t(e.item())
          ? Me.some(e.item())
          : Zl(n, e.item(), t, e.mode(), o, i)
      })
    },
    ef = function(e, n, t, r) {
          ...
          .bind(function(e) {
            return et(n, 'td,th', u).map(function(n) {
              return In(e, n)
                ? In(r, e) && wt(e) === o
                  ? i(n)
                  : of.none('in same cell')
                : fr.sharedOne(ul, [e, n]).fold(
                    function() {
                      return (function(e, n, t) {
                        var r = e.getRect(n),
                          o = e.getRect(t)
    ...
    mf = {
      nu: df,
      moveUp: function(e, n) {
        return df({ left: e.left(), top: e.top() - n, right: e.right(), bottom: e.bottom() - n })
      },
      ...
      moveBottomTo: function(e, n) {
        ...
        return df({ left: e.left(), top: n - t, right: e.right(), bottom: n })
      },
      moveTopTo: function(e, n) {
        var t = e.bottom() - e.top()
        return df({ left: e.left(), top: n, right: e.right(), bottom: n + t })
      },
      getTop: function(e) {
        return e.top()
      },
    ...
    vf = {
      ...
      adjuster: function(e, n, t, r, o) {
        ...
        return Math.abs(t.top() - r.top()) < 1
          ...
          ? hf.retry(i)
          : t.bottom() === o.top()
          ? hf.retry(mf.moveUp(o, 1))
          : sl(e, n, o)
          ? hf.retry(mf.translate(i, 5, 0))
          : hf.none()
      },
      move: mf.moveUp,
      gather: ol
    ...
    Cf = me(),
    Sf = function(r, o, i, u, c, a) {
      return 0 === a
        ? Me.none()
        : Tf(r, o, i, u, c).bind(function(e) {
            var n = r.fromSitus(e),
            ...
            return uf.cata(
              ...
              function(e) {
                return In(i, e) && u === wt(e)
                  ? xf(r, i, u, mf.moveDown, c)
                  : Sf(r, o, e, wt(e), c, a - 1)
              }
            )
          })
    ...
    Rf = function(e, n, t) {
      return Cf.browser.isChrome() ||
        Cf.browser.isSafari() ||
        Cf.browser.isFirefox() ||
        Cf.browser.isEdge()
        ? n.otherRetry(e, t)
        : Cf.browser.isIE()
        ? n.ieRetry(e, t)
    ...
    Of = function(n, t, r) {
      return (function(o, i, u) {
        return o.getSelection().bind(function(r) {
          return ff(i, r.finish(), r.foffset(), u).fold(
            function() {
    ...
    Df = me(),
    Af = function(e, n, t, r, o, i) {
      return Df.browser.isIE()
        ? Me.none()
        : i(r, n).orThunk(function() {
            return gl(e, n, t, r, o).map(function(e) {
              var n = e.range()
              return Hl.create(
                Me.some(Ul.makeSitus(n.start(), n.soffset(), n.finish(), n.foffset())),
                !0
              )
            })
          })
    },
    Ef = function(e, n, t, r, o, i, u) {
  ...
  var Mf = {
    ...
    _f = If(40),
    Lf = {
      ltr: { isBackward: If(37), isForward: If(39) },
      rtl: { isBackward: If(39), isForward: If(37) },
      isUp: Wf,
      isDown: _f,
            ...
            mouseover: function(e) {
              r.each(function(r) {
                u.clearBeforeUpdate(i),
                  pl(e.target(), n).each(function(t) {
                    dr(r, t, n).each(function(e) {
                      var n = e.boxes().getOr([])
                      ;(1 < n.length || (1 === n.length && !In(r, t))) &&
        ...
        return {
          keydown: function(e, n, t, r, o, i) {
            ...
            return mr(l, s.selectedSelector()).fold(
              function() {
                return Lf.isDown(c) && a
                  ? b(Ef, m, l, f, Mf.down, r, n, s.selectRange)
                  : Lf.isUp(c) && a
                  ? b(Ef, m, l, f, Mf.up, r, n, s.selectRange)
                  : Lf.isDown(c)
                  ? b(Af, m, f, Mf.down, r, n, kf)
                  : Lf.isUp(c)
                  ? b(Af, m, f, Mf.up, r, n, Nf)
                  : Me.none
              },
              function(n) {
                function e(e) {
                  return function() {
                    return bo(e, function(e) {
                      ...
                      function() {
                        return pr(l, s.firstSelectedSelector(), s.lastSelectedSelector()).map(
                          function(e) {
                            var n = Lf.isDown(c) || i.isForward(c) ? El.after : El.before
                            return (
                              m.setRelativeSelection(El.on(e.first(), 0), n(e.table())),
                              s.clear(l),
                              Hl.create(Me.none(), !0)
                            )
                          }
          ...
          keyup: function(t, r, o, i, u) {
            return mr(l, s.selectedSelector()).fold(function() {
              ...
              return !1 == (!0 === e.shiftKey)
                ? Me.none()
                : Lf.isNavigation(n)
                ? Vl.sync(l, f, r, o, i, u, s.selectRange)
                : Me.none()
            }, Me.none)
          }
        }
  ...
  function Jf(n) {
    var e = Gf(n),
      ...
      u = R(Me.none())
    return (
      ua.registerCommands(n, i, o, e, u),
      Nr.registerEvents(n, e, i, o),
      Xf.addMenuItems(n, t),
      Kf.addButtons(n, t),
      Kf.addToolbars(n),
