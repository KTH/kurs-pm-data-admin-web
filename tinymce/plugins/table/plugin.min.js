...
!(function () {
      ...
      A(e.cells, function (e) {
        ...
        for (
          var t = be(a, n.toString()),
            r = { element: e.element, rowspan: e.rowspan, colspan: e.colspan, row: s, column: n, isLocked: t },
            o = 0;
          o < e.colspan;
          o++
        )
      ...
      A(i, function (e, r) {
        ...
        c.push(o),
          (t[o] = function () {
            ...
            if (n !== u.length)
              throw new Error(
                'Wrong number of arguments to case ' + o + '. Expected ' + u.length + ' (' + u + '), got ' + n
              )
            return {
              fold: function () {
                for (var e = [], n = 0; n < arguments.length; n++) e[n] = arguments[n]
          ...
          j(Ql(e)).each(function (c) {
            rt(c).each(function (e) {
              var n,
                ...
                o,
                u = k(
                  ((n = l.content), ((t = document.createElement('div')).innerHTML = n), ln(Ve.fromDom(t))),
                  function (e) {
                    return 'meta' !== Ye(e)
                  }
                ),
  ...
  function Qi(e, u, n, i, c) {
    ...
    return (function (e, n, t) {
      ...
      return (function (e, n, t, r, o, u) {
        for (
          var i, c, l, a, f, s = e.row, m = e.column, d = s + t.length, g = m + dt(t[0]) + u.length, p = L(u, x), b = s;
          b < d;
          b++
        )
      ...
      return jo(o)
        .bind(function (t) {
          ...
          return rn(t).map(function (e) {
            return !0 === r || 'li' === Ye((n = e)) || Dn(n, pc).isSome() || u(t) || (gc(e) && !ce(o, e))
              ? []
              : [Ve.fromTag('br')]
            var n
          })
  ...
  function ul(e, n) {
    ...
    return {
      title: 'Advanced',
      name: 'advanced',
      items: 'cell' === n ? [{ name: 'borderwidth', type: 'input', label: 'Border width' }].concat(t) : t,
    }
  }
  function il(u) {
    return function (t, r) {
      ...
      return {
        ...
        setFormat: function (e, n) {
          ;(u && !n) ||
            ('' === n ? t.formatter.remove(e, { value: null }, r, !0) : t.formatter.apply(e, { value: n }, r))
        },
      }
    }
  }
  ...
  function vl(e, n) {
          ...
          (S = K(
            {
              ...
              border:
                ...
                ti(m) && h.isSome()
                  ? h.getOr('')
                  : p.getAttrib(b, 'border') || Fc(m.dom, b, 'border-width') || Fc(m.dom, b, 'border')),
    ...
    var x,
      ...
      k = ni(e)
        ? { type: 'tabpanel', tabs: [{ title: 'General', name: 'general', items: [A] }, ul(e, 'table')] }
        : { type: 'panel', items: [A] }
    e.windowManager.open({
  ...
  var Ys = function (e, n, t, r) {
    ...
    Js = document.caretPositionFromPoint
      ? function (t, e, n) {
          var r, o
          return q
            .from(null === (o = (r = t.dom).caretPositionFromPoint) || void 0 === o ? void 0 : o.call(r, e, n))
            .bind(function (e) {
      ...
      I.on('init', function (e) {
          ...
          k =
            ...
            (A = Xc(0)),
            {
              touchEnd: function (e) {
                ...
                ;('td' !== Ye(r) && 'th' !== Ye(r)) ||
                  ((n = O.get()), (t = A.get()), ce(n, r) && e.timeStamp - t < 300 && (e.preventDefault(), S(r, r))),
                  O.set(r),
                  A.set(e.timeStamp)
              },
            })
        I.on('dragstart', function (e) {
          ...
          I.on('mouseover', function (e) {
            var n
            ;(void 0 === (n = e).buttons || (Im.browser.isEdge() && 0 === n.buttons) || 0 != (1 & n.buttons)) &&
              $s(e) &&
              y.mouseover(ma(e))
          }),
