            ...
            var t = e.getData(),
              n = (function (e, o, t) {
                ...
                s ||
                  ...
                  (a = c.getAll('title')[0]),
                  o.title
                    ? (a ? a.empty() : r((a = new f('title', 1))), (a.append(new f('#text', 3)).value = o.title))
                    : a && a.remove(),
  ...
  function s(e, t, n, l) {
    ...
    l.selection ||
      ...
      ('raw' === l.format && t.get()) ||
        ...
        (-1 !==
        (i = (r = (r =
          0 !== r.length || l.source_view ? r : w.trim(t.get()) + '\n' + w.trim(r) + '\n' + w.trim(n.get())).replace(
          /<(\/?)BODY/gi,
          '<$1body'
        )).indexOf('<body'))
          ? ((i = r.indexOf('>', i)),
        ...
        w.each(s.getAll('link'), function (e) {
          ...
          m[t] ||
            ...
            v.add(u, 'link', { rel: 'stylesheet', text: 'text/css', href: t, 'data-mce-fullpage': '1' }),
            delete m[t]
        }),
        w.each(m, function (e) {
