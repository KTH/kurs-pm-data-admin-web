  ...
  !(function (e, n) {
    ...
    ;(window.Prism = { manual: !0 }),
        ...
        return (
              ...
              j = {
                ...
                highlightElement: function (e, n, t) {
                  ...
                  s &&
                    ...
                    (s.className = s.className.replace(c, '').replace(/\s+/g, ' ') + ' language-' + a)
                  var i,
          ...
          (function (t) {
            ...
            ;(t.languages.csharp = t.languages.extend('clike', {
              ...
              'class-name': [
                { pattern: r(/(\busing\s+static\s+)<<0>>(?=\s*;)/.source, [h]), lookbehind: !0, inside: x },
                { pattern: r(/(\busing\s+<<0>>\s*=\s*)<<1>>(?=\s*;)/.source, [m, _]), lookbehind: !0, inside: x },
                ...
                { pattern: r(/(\b(?:is(?:\s+not)?|as)\s+)<<0>>/.source, [w]), lookbehind: !0, inside: x },
                {
              ...
              t.languages.insertBefore('csharp', 'class-name', {
                ...
                'type-expression': {
                  pattern: r(/(\b(?:default|typeof|sizeof)\s*\(\s*(?!\s))(?:[^()\s]|\s(?!\s)|<<0>>)*(?=\s*\))/.source, [
                    b,
                  ]),
                  lookbehind: !0,
                  alias: 'class-name',
          ...
          (s.languages.java = s.languages.extend('clike', {
            'class-name': [
              l,
              { pattern: RegExp(o + /[A-Z]\w*(?=\s+\w+\s*[;,=()])/.source), lookbehind: !0, inside: l.inside },
            ],
            keyword: i,
      ...
      'object' == typeof e && void 0 !== n
        ? (n.exports = a())
        : ((t = 'undefined' != typeof globalThis ? globalThis : t || self).EphoxContactWrapper = a())
    window.Prism
    window.Prism = r
  })(b, m)
