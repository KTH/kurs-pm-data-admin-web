                ...
                switch (t) {
                  case 'mso-list':
                    ...
                    n && (o._listLevel = parseInt(n[1], 10)),
                      /Ignore/i.test(e) && o.firstChild && ((o._listIgnore = !0), (o.firstChild._listIgnore = !0))
                    break
                  case 'horiz-align':
                    t = 'text-align'
                    break
        ...
        for (var t, n, r, a = e.length; a--; )
          (n = (t = e[a]).attr('href')),
            ...
            n && -1 !== n.indexOf('#_msocom_')
              ? t.remove()
              : (!(n = n && 0 === n.indexOf('file://') ? (n = n.split('#')[1]) && '#' + n : n) && !r) ||
                      ...
                      ? ((c = void 0),
                        (i = (o = t.editorUpload.blobCache).getByData(v, h))
                          ...
                          : ((l = (s = t.getParam('images_reuse_filename') && P(b.name))
                              ? ((f = t),
                                P((d = b.name.match(/([\s\S]+?)(?:\.[a-z0-9.]+)$/i))) ? f.dom.encode(d[1]) : null)
                              : y),
                            (u = s ? b.name : void 0),
    ...
    ;(s = o),
      ...
      s.on('keydown', function (e) {
        ...
        if (
          ...
          (!(u = e.shiftKey && 86 === e.keyCode) || !pe.webkit || -1 === navigator.userAgent.indexOf('Version/'))
        ) {
