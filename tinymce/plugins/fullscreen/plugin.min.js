...
!(function () {
  ...
  function V(e, n, r) {
    !(function (e, n, r) {
      if (!(l(r) || o(r) || i(r)))
        throw (
          (console.error('Invalid call to Attribute.set. Key ', n, ':: Value ', r, ':: Element ', e),
      ...
      for (var n, r = R(e), t = 0, o = r.length; t < o; t++) {
        ...
        ;(n = e[i]),
          (function (e, n, r) {
            if (!l(r))
              throw (
                (console.error('Invalid call to CSS.set. Property ', n, ':: Value ', r, ':: Element ', e),
        ...
        : ((n = $(
          ...
          (r = {
            scrollPos:
              ...
              (g = v.document),
              (d =
                (m = void 0 !== (f = L.fromDom(g)) ? f.dom : document).body.scrollLeft || m.documentElement.scrollLeft),
