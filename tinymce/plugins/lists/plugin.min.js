...
!(function () {
    ...
    var r,
      o = (function (e, t, n) {
        for (var r, o, i, a = [], s = 0; s < n; s++)
          a.push(
            ((o = t.listType), we((i = { list: me.fromTag(o, (r = e)), item: me.fromTag('li', r) }).list, i.item), i)
          )
        return a
    ...
    'false' !== l.getContentEditable(u.selection.getNode()) &&
      ...
      Mt.each(t, function (e) {
        ...
        Ft(s) ||
          ...
          Ut(a) &&
          a.nodeName === c &&
          ((o = f), l.getStyle(a, 'list-style-type') === (i = null === (i = o ? o['list-style-type'] : '') ? '' : i))
  ...
  function Dt(e, t, n, r) {
    ...
    var s,
      ...
      c = new ve(o, r)
    for (
      n && ((s = e.dom), Kt((u = o)) && s.isBlock(u.nextSibling) && !Kt(u.previousSibling) && c.next());
      (o = c[n ? 'next' : 'prev2']());
