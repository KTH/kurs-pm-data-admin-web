...
!(function(r) {
  ...
  function Te(r, o, i) {
    ...
    'false' !== s.getContentEditable(r.selection.getNode()) &&
      ...
      Pn.each(
        (function(t, e, r) {
          for (
            var o, i = [], u = t.dom, n = Le(t, e, !0, r), s = Le(t, e, !1, r), a = [], c = n;
            c && (a.push(c), c !== s);
            c = c.nextSibling
          );
          return (
  ...
  function we(e, n) {
    ...
    'LI' === r.nodeName &&
      ...
      Un(r) && (t = r.previousSibling) && 'LI' === t.nodeName && t.appendChild(n)
  }
  function ke(e, n, t, r) {
  ...
  function Re(n, e, t) {
    ...
    if (Qn(n, e) && Qn(n, t)) {
      Un(t.lastChild) && (o = t.lastChild),
        i === t.lastChild && qn(i.previousSibling) && n.remove(i.previousSibling),
  ...
  function Pe(e, n) {
    return e.selection.isCollapsed()
      ...
      : (function(e) {
          ...
          return (
            !!(e.dom.getParent(n, 'LI,DT,DD', t) || 0 < Jn.getSelectedListItems(e).length) &&
            (e.undoManager.transact(function() {
  ...
  var Fe,
    ...
    Nn = [
      ...
      { name: 'Opera', versionRegexes: [hn, /.*?opera\/([0-9]+)\.([0-9]+).*/], search: w('opera') },
      {
        name: 'Firefox',
    ...
    yn = [
      ...
      { name: 'OSX', search: w('os x'), versionRegexes: [/.*?os\ x\ ?([0-9]+)_([0-9]+).*/] },
          ...
          1 === t.nodeType &&
            ...
            t.hasChildNodes()
              ? ((r = Math.min(r, t.childNodes.length - 1)),
                e ? t.insertBefore(n, t.childNodes[r]) : at.insertAfter(n, t.childNodes[r]))
              : t.appendChild(n),
            (t = n),
            (r = 0)),
        ...
        ;(n = r = o[e ? 'startContainer' : 'endContainer']),
          ...
          n &&
            (1 === n.nodeType &&
              ...
              (n = n.parentNode),
              at.remove(r),
              !n.hasChildNodes() && at.isBlock(n) && n.appendChild(at.create('br'))),
