...
!(function(s) {
  ...
  function G(t) {
    H(t)
      ...
      : (function(t) {
          ...
          zt.insertAfter(e, t),
            e.appendChild(t),
            e.appendChild(zt.create('figcaption', { contentEditable: 'true' }, 'Caption')),
  ...
  function ot(e, t) {
    var n = (function(t, e) {
      ...
      if ((Mt(t, _t(e, { caption: !1 }), n), B(n, 'alt', e.alt), e.caption)) {
        ...
        return (
          r.appendChild(n),
          r.appendChild(zt.create('figcaption', { contentEditable: 'true' }, 'Caption')),
  ...
  var lt = C.exports.boltExport,
    ...
    Pt = function(t, e) {
      ...
      ;(r.onload = function() {
        var t = { width: j(r.width, r.clientWidth), height: j(r.height, r.clientHeight) }
        n(yt.value(t))
      }),
        (r.onerror = function() {
    ...
    kt = function(t) {
      return (
        'IMG' === t.nodeName &&
        (t.hasAttribute('data-mce-object') || t.hasAttribute('data-mce-placeholder'))
      )
    },
    zt = At.DOM,
    Mt = function(t, e, n) {
  ...
  function te(t, e, n) {
    ...
    return (
      (i.vspace = (function(t) {
        return t['margin-top'] && t['margin-bottom'] && t['margin-top'] === t['margin-bottom']
          ? Et(String(t['margin-top']))
          : ''
      })(r)),
      (i.hspace = (function(t) {
        return t['margin-right'] && t['margin-left'] && t['margin-right'] === t['margin-left']
          ...
          return t.hasAdvTab || t.hasUploadUrl || t.hasUploadHandler
            ? {
                ...
                tabs: v([
                  [Ut(t)],
                  t.hasAdvTab ? [ae(t)] : [],
                  t.hasUploadTab && (t.hasUploadUrl || t.hasUploadHandler) ? [ue(t)] : []
                ])
              }
    ...
    return function(t) {
      for (
        ...
        void 0,
          (e = i.attr('class')) &&
            /\bimage\b/.test(e) &&
            (i.attr('contenteditable', o ? 'false' : null), Ht.each(i.getAll('figcaption'), r))
      }
    }
  }
  var ae = function(t) {
