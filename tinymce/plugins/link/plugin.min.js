  ...
  ;(K = undefined),
    ...
    (function(n) {
      ...
      return (function l(i, u, c) {
        ...
        for (var f = 'function' == typeof W && W, n = 0; n < c.length; n++) a(c[n])
        return a
      })(
        {
          1: [
  ...
  var _n = gn.exports.boltExport,
      ...
      return U(
        [
          ...
          (function(e) {
            return function(n) {
              var t = n.href
              return (1 === e && !ln(t)) || (0 === e && /^\s*www[\.|\d\.]/i.test(t))
                ? $.some({
                    message:
      ...
      return Fn(e).map(function(n) {
        var t = (function(n, t) {
          var e = n.dom,
            ...
            u = wn(e, t, 'rel'),
            c = wn(e, t, 'class')
          return { url: o, text: r, title: wn(e, t, 'title'), target: i, rel: u, linkClass: c }
        })(e, r)
        return {
          anchor: t,
          catalogs: {
    ...
    Xn = function(i) {
      ...
      i.ui.registry.addContextForm('quicklink', {
        launch: { type: 'contextformtogglebutton', icon: 'link', tooltip: 'Link', onSetup: Bn(i) },
        label: 'Link',
